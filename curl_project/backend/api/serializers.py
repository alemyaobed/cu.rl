...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['uuid', 'username', 'email', 'date_joined', 'last_login', 'is_active', 'is_staff', 'is_superuser']
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['user', 'surname', 'other_names', 'bio', 'location', 'birth_date', 'website', 'profile_picture', 'total_urls', 'last_url_created', 'premium_user']
