"""
Django settings for curl_project project.
...
SECRET_KEY = 'django-insecure-4jk0g1j!!q2i&l+4^5e7a(o*21&rdz%z5z3czzrm5_d@lt5_f#'
...
# POSTGRESQL database connection string for the database
DATABASES = {
    'default': {
